...
```bash
curl -fsSL https://raw.githubusercontent.com/DevOpsAIguru123/job-hunt/main/open-source-agent-setup/install.sh | bash -s -- --yes
```
...
cd job-hunt/open-source-agent-setup
bash install.sh --yes
npm install
npm run test:setup
```
